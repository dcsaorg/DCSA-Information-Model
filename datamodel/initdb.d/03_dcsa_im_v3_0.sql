...
CREATE TABLE dcsa_im_v3_0.booking (
    ...
    expected_arrival_date_at_final_destination_start date NULL CHECK ((expected_arrival_date_at_final_destination_start IS NULL) OR (expected_arrival_date_at_final_destination_end IS NULL) OR expected_arrival_date_at_final_destination_start <= expected_arrival_date_at_final_destination_end),
    expected_arrival_date_at_final_destination_end date NULL,
