...
CREATE TABLE dcsa_im_v3_0.booking (
    ...
    expected_arrival_date_start date NULL CHECK ((expected_arrival_date_start IS NULL AND expected_arrival_date_end IS NULL) OR (expected_arrival_date_start IS NOT NULL) OR (expected_arrival_date_end IS NOT NULL) OR expected_arrival_date_start <= expected_arrival_date_end),
