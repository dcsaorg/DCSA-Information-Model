...
--- Supporting tables for Electronic Endorcement chain PoC

DROP TABLE IF EXISTS dcsa_im_v3_0.address_book_entry CASCADE;
CREATE TABLE dcsa_im_v3_0.address_book_entry (
	id int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	ebl_platform varchar(255) NULL,
	name text NULL,
...
DROP TABLE IF EXISTS dcsa_im_v3_0.bill_of_lading CASCADE;
CREATE TABLE dcsa_im_v3_0.bill_of_lading (
	document_hash varchar(255) NOT NULL PRIMARY KEY,
	also_notify_party varchar(255) NULL,
	basis varchar(255) NULL,
	blno varchar(255) NULL,
	booking_no_carrier_ref varchar(255) NULL,
	cargo_gross_weights varchar(255) NULL,
	cargo_movement_type varchar(255) NULL,
	carrier_clauses varchar(255) NULL,
	collect varchar(255) NULL,
	consignee varchar(255) NULL,
	container_numbers varchar(255) NULL,
	date_of_issue varchar(255) NULL,
	description_of_goods varchar(255) NULL,
	export_import_svc_ref varchar(255) NULL,
	forwarding_agent_references varchar(255) NULL,
	freight_and_charges varchar(255) NULL,
	freight_and_charges_payable_by_at varchar(255) NULL,
	hs_code varchar(255) NULL,
	is_part_load varchar(255) NULL,
	no_and_sequence_of_originalbls varchar(255) NULL,
	notify_party varchar(255) NULL,
	onward_inland_routing_final_destination varchar(255) NULL,
	place_of_delivery varchar(255) NULL,
	place_of_issue varchar(255) NULL,
	place_of_receipt varchar(255) NULL,
	point_and_country_of_origin_of_goods varchar(255) NULL,
	port_of_discharge varchar(255) NULL,
	port_of_loading varchar(255) NULL,
	pre_carriage_by varchar(255) NULL,
	prepaid varchar(255) NULL,
	rate varchar(255) NULL,
	receipt_delivery_type varchar(255) NULL,
	reefer_settings varchar(255) NULL,
	seal_nos varchar(255) NULL,
	shipped_on_board_date varchar(255) NULL,
	shipper varchar(255) NULL,
	shipper_declared_value varchar(255) NULL,
	size_types varchar(255) NULL,
	total_freight varchar(255) NULL,
	total_number_of_containers_received varchar(255) NULL,
	vessel varchar(255) NULL,
	voyage_no varchar(255) NULL
);

DROP TABLE IF EXISTS dcsa_im_v3_0.eec_transport_document CASCADE;
CREATE TABLE dcsa_im_v3_0.eec_transport_document (
	document_hash varchar(255) NOT NULL PRIMARY KEY,
	transport_document_json text NULL
);

DROP TABLE IF EXISTS dcsa_im_v3_0.transport_document_transfer CASCADE;
CREATE TABLE dcsa_im_v3_0.transport_document_transfer (
	transfer_block_hash varchar(255) NOT NULL PRIMARY KEY,
	previous_transfer_block_hash text NULL,
	transfer_block text NULL,
	transfer_status varchar(255) NULL DEFAULT 'current'::character varying
);
