...
DROP TABLE IF EXISTS dcsa_im_v3_0.addressbookentry CASCADE;
CREATE TABLE dcsa_im_v3_0.addressbookentry (
...
DROP TABLE IF EXISTS dcsa_im_v3_0.billoflading CASCADE;
CREATE TABLE dcsa_im_v3_0.billoflading (
...
DROP TABLE IF EXISTS dcsa_im_v3_0.transportdocumenttransfer CASCADE;
CREATE TABLE dcsa_im_v3_0.transportdocumenttransfer (
