...
ALTER TABLE dcsa_im_v3_0.booking
    ADD COLUMN IF NOT EXISTS event_created_date_time timestamp with time zone NOT NULL;
ALTER TABLE dcsa_im_v3_0.booking
    ADD COLUMN IF NOT EXISTS event_date_time timestamp with time zone NOT NULL;
COMMIT;
