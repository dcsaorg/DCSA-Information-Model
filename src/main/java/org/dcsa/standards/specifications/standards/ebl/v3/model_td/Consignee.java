...
public class Consignee {
  ...
  public static final String CLASS_SCHEMA_DESCRIPTION = "The party to which goods are consigned in the Master Bill of Lading. Required for non-negotiable BL (`isToOrder=false`).";
