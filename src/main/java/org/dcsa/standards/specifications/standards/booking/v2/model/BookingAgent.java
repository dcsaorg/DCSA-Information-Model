...
@Schema(description = BookingAgent.CLASS_SCHEMA_DESCRIPTION)
@Data
public class BookingAgent {

  public static final String CLASS_SCHEMA_DESCRIPTION = "The party placing the booking request on behalf of the customer.";
