...
public class EndorsementChain {
  ...
  public static final String CLASS_SCHEMA_DESCRIPTION = "An endorsement Chain linked to a particular `transportDocumentReference` and potentially a `transportDocumentSubReference`.";
