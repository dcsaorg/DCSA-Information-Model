...
import org.dcsa.standards.specifications.standards.ebl.v3.types.RequestedCarrierCertificate;
...
public class ShippingInstructions {
  ...
  public static final String CLASS_SCHEMA_DESCRIPTION = "The `Shipping Instructions` as provided by the Shipper.";
