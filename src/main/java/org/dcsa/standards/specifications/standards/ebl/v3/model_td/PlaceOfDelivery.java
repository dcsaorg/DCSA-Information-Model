...
public class PlaceOfDelivery {
  ...
  public static final String CLASS_SCHEMA_DESCRIPTION = "Location where the cargo is handed over to the consignee by the shipping line. Can be specified using UN Location Code, Facility, Address, or Geo Coordinate.";
