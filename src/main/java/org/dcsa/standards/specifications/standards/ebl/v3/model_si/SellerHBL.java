...
@Schema(description = SellerHBL.CLASS_SCHEMA_DESCRIPTION, title = "Seller (House B/L)")
@Data
public class SellerHBL {

  public static final String CLASS_SCHEMA_DESCRIPTION = "The seller for a `House Bill of Lading`.";
