...
@Schema(
    description = SupportingDocument.CLASS_SCHEMA_DESCRIPTION,
    title = "Supporting Document",
    requiredProperties = {"name", "content"})
@Data
public class SupportingDocument {

  public static final String CLASS_SCHEMA_DESCRIPTION = "A binary document representing the visualisation of the eBL.";
