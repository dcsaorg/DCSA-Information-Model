...
@Schema(description = "The Location specifying where the place of departure is located.")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class PlaceOfDeparture
    extends org.dcsa.standards.specifications.standards.cs.v102.model.PlaceOfDeparture {
